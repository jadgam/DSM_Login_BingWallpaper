...
[ -s $tmpfile ]||exit
#echo -n "替换桌面背景图片Replacing wallpaper..."
...
#echo " ok!"&&echo -n "替换登录背景图片Replacing login_background..."
rm -rf /usr/syno/etc/login_background*.jpg
cp -f $tmpfile /usr/syno/etc/login_background.jpg &>/dev/null
cp -f -l /usr/syno/etc/login_background.jpg /usr/syno/etc/login_background_hd.jpg &>/dev/null
